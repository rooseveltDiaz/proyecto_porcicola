    ...
    <body>
        <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
            ...
            <?php if (session::getInstance()->hasUserId()): ?>   
                <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">          <header class="demo-drawer-header">
                        <?php if (session::getInstance()->hasCredential('admin') == 1): ?>
                            <img src="<?php echo routing::getInstance()->getUrlImg('diaz.jpg') ?>" class="demo-avatar">
                        <?php endif; ?>
                        <div class="demo-avatar-dropdown">
                            <span><?php echo session::getInstance()->getAttribute('correoUser') ?></span>
...
<!--                                <a onclick="location.href = '<?php echo routing::getInstance()->getUrlWeb('animal', 'indexGestacion') ?>'" > <button class="mdl-menu__item glyphicon glyphicon-calendar"><?php echo i18n::__('read', null, 'gestacion') ?></button></a>                               
                     ...
                     <!--   <div class="demo-avatar-dropdown" style="margin-left: 5px">
                        ...
                        <?php if (session::getInstance()->hasCredential('admin')): ?>
                            <a id="admin" href="#" target="_blank" onclick="location.href = '<?php echo routing::getInstance()->getUrlObj('Manual-de-admon.pdf') ?>'"<i class="mdl-color-text--blue-400 text-center material-icons">help_outline</i></a>
                ...
                <header class="demo-header mdl-layout__header  mdl-color--white mdl-color--grey-100 mdl-color-text--grey-600">
                    <div class="mdl-layout__header-row">
                        ...
                        <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right" for="hdrbtn">
                            <a data-toggle="modal" data-target="#myModalSobre"  href="#"><li  class="mdl-menu__item fa fa-laptop"><?php echo i18n::__('sobre') ?></li></a>
                            <a data-toggle="modal" data-target="#myModalContact" href="#"> <li class="mdl-menu__item fa fa-phone"><?php echo i18n::__('contacto') ?></li></a>
            ...
            <?php endif; ?>
              ...
              <div class="modal fade" id="myModalSobre" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-footer">
                        <a href="#close2" data-dismiss="modal"  title="Close" class="btn btn-default close2"><?php echo i18n::__('cerrar') ?></a>
                    </div>
                </div>
            </div>
              </div>
                        ...
                        <div class="pre-scrollable">
                            <div class="modal-body text-left">
                                <p>
                                    ...
                                    <br/>
                                    <?php echo i18n::__('centro', null, 'ayuda') ?>
                                    <br/>
                            ...
                            <div class="modal-body text-right ">
                                <p>
                                    <?php echo i18n::__('name3', null, 'ayuda') ?>
                                    <br />
                                    <?php echo i18n::__('cel3', null, 'ayuda') ?>
                                    <br/>
                                    <?php echo i18n::__('correo3', null, 'ayuda') ?>
                                </p>
                            </div>                   
                            <div class="modal-body text-right">
                                <p>
                                    <?php echo i18n::__('name2', null, 'ayuda') ?>
                                    <br />
                                    <?php echo i18n::__('cel2', null, 'ayuda') ?>
                                    <br/>
                                    <?php echo i18n::__('correo2', null, 'ayuda') ?>
                                </p>
                            </div>  
                            <div class="modal-body text-right">
                                <p>
                                    <?php echo i18n::__('name1', null, 'ayuda') ?>
                                    <br />
                                    <?php echo i18n::__('cel1', null, 'ayuda') ?>
                                    <br/>
                                    <?php echo i18n::__('correo1', null, 'ayuda') ?>
                                </p>
                            </div>
                            <div class="modal-body text-right">
                                <p>
