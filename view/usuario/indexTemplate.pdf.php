...
$pdf->Cell(27, 10, utf8_decode('Ciudad '), 1);
$pdf->Ln();
...
//    $pdf->Cell(20, 10, utf8_encode($key->ciudad_id), 1);
    ...
    $pdf->Cell(40, 10, utf8_decode($key->nombre), 1);
    $pdf->Cell(40, 10, utf8_decode($key->apellidos), 1);
    $pdf->Cell(25, 10, utf8_decode($key->telefono), 1);
    $pdf->Cell(42, 10, utf8_decode($key->direccion), 1);
    $pdf->Cell(27, 10, utf8_decode($key->nombre_ciudad), 1);
