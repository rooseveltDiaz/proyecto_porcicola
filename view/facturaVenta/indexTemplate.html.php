        ...
        <div class="container container-fluid">
            ...
            <!--                                                <a id="habilitar<?php echo $countDetale ?>"   href="#changeState<?php echo $key->$id ?>" class="btn btn-sm btn-default fa fa-ban" ></a>
                        ...
                        <div class="modalmask" id="myModalDetail<?php echo $key->$id ?>">
                            <div class="modalbox rotate">
                                <form id="detailForm" name="detailForm" class="form-horizontal" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('factura', 'createDetalleFacturaVenta')  ?>">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <br/>
                                        <?php echo i18n::__('valor', null, 'dpVenta') ?>
