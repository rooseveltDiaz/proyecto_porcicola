    ...
    <div class="container container-fluid">
      <div class="row">
        <div class="col-xs-4-offset-4 text-center">
          <h2>
            <?php echo i18n::__('read', null, 'proveedor') ?>
          </h2>
        </div>
      </div>
...
<?php endif; ?>
            ...
            <a id="report" href="<?php echo routing::getInstance()->getUrlWeb('personal', 'reportProveedor') ?>" class="btn btn-primary active btn-sm fa fa-download"></a>
                ...
                <div id="myModalDelete<?php echo $key->$id ?>" class="modalmask">
                  <div class="modalbox rotate">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary fa fa-eraser" onclick="eliminar(<?php echo $key->$id ?>, '<?php echo proveedorTableClass::getNameField(proveedorTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('personal', 'deleteProveedor') ?>')"><?php echo i18n::__('delete') ?></button>
                    </div>
                  </div>
                </div>
                <?php $countDetale++ ?>
