...
$numero_documento= clienteTableClass::NUMERO_DOC;
$nombre = clienteTableClass::NOMBRE;
$telefono = clienteTableClass::TEL;
$direccion = clienteTableClass::DIRECCION;
...
$pdf->Cell(5);
$pdf->Cell(47, 10, utf8_decode('Tipo Documento'), 1);
$pdf->Cell(43, 10, utf8_decode('Numero Documento'), 1);
$pdf->Cell(65, 10, utf8_decode('Nombre Completo'), 1);
...
foreach ($objCliente as $key) {
    $pdf->Cell(5);
    $pdf->Cell(47, 10, utf8_decode($key->$tipo_doc), 1);
    $pdf->Cell(43, 10, utf8_decode($key->$numero_documento), 1);
    $pdf->Cell(65, 10, utf8_decode($key->$nombre), 1);
