...
$pdf->Cell(1);
$pdf->Cell(38, 10, utf8_decode('Tipo Documento'), 1);
$pdf->Cell(32, 10, utf8_decode('Número'), 1);
$pdf->Cell(63, 10, utf8_decode('Nombre Completo'), 1);
$pdf->Cell(35, 10, utf8_decode('Telefono'), 1);
$pdf->Cell(42, 10, utf8_decode('Direccion'), 1);
$pdf->Cell(30, 10, utf8_decode('Ciudad'), 1);
$pdf->Cell(27, 10, utf8_decode('cargo'), 1);
$pdf->Ln();
foreach ($objEmpleado as $key) {
    $pdf->Cell(1);
    $pdf->Cell(38, 10, utf8_decode($key->$tipo_doc), 1);
    $pdf->Cell(32, 10, utf8_decode($key->$numero_documento), 1);
    $pdf->Cell(63, 10, utf8_decode($key->$nombre), 1);
    ...
    $pdf->Cell(27, 10, utf8_decode($key->$cargo_id), 1);
    $pdf->Ln();
}
$pdf->Output();
