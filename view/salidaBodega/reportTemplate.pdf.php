...
$pdf->Cell(30);
$pdf->Cell(40, 10, utf8_decode('Numero Documento'), 1);
$pdf->Cell(43, 10, utf8_decode('Fecha del Registro'), 1);
$pdf->Cell(100, 10, utf8_decode('Empleado'), 1);

$pdf->Ln();
foreach ($objSalida as $key) {
    $pdf->Cell(30);
    $pdf->Cell(40, 10, utf8_decode($key->$doc), 1);
    $pdf->Cell(43, 10, utf8_decode($key->$fecha), 1);
    $pdf->Cell(100, 10, utf8_decode($key->$empleado), 1);
