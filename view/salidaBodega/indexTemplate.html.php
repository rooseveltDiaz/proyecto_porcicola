                ...
                <div class="col-xs-12 text-center">
                 ...
                 <!--       <a id="deleteMasa" href="#" data-target="#myModalEliminarMasivo" data-toggle="modal" class="btn btn-default btn-sm fa fa-exchange"></a>
                    ...
                    <div class="mdl-tooltip mdl-tooltip--large" for="deleteFilter">
                       ...
                       <a id="buscarReporteDetalle" href="<?php echo routing::getInstance()->getUrlWeb('bodega', 'reportSalidaBodega') ?>" class="btn btn-primary active btn-sm fa fa-download" ></a>
                        ...
                        <tbody>
                            <?php foreach ($objSalidaBodega as $key): ?>
                                ...
                                <!--      <?php if (session::getInstance()->hasCredential('admin') == 1): ?>
                                    ...
                                    <td><?php echo date("d-m-Y - G:i", strtotime($key->$fechaEntrada))  ?></td>
...
<!--                                                   <a id="habilitar<?php echo $countDetale ?>"  href="#changeState<?php echo $key->$id ?>" class=" btn btn-sm btn-default fa fa-ban" ></a>
                                        ...
                                        <?php elseif (session::getInstance()->hasCredential('admin') == 1): ?>
                                        <a id="habilitar<?php echo $countDetale ?>"  href="#changeState<?php echo $key->$id ?>" class=" btn btn-sm btn-default fa fa-ban" ></a>
                                        <div class="mdl-tooltip mdl-tooltip--large" for="habilitar<?php echo $countDetale ?>">
    ...
    <div class="modalbox rotate">
        ...
        <div class="modal-body">
            <form id="filterForm" class="form-horizontal" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('bodega', 'indexSalida') ?>">
                <table class="table table-bordered">
                                      <tr>
                                      <th> <?php echo i18n::__('fechaInicio') ?>:</th>
                                      <th>     <input name="filter[fecha_inicio]" type="date">
                        </th>
                                  </tr>
                                  <tr>
                        <th>
                          <?php echo i18n::__('fechaFin') ?>:</th>
                        <th>  <input name="filter[fecha_fin]" type="date">
                        </th>
                    </tr>
                    <tr>
...
<div class="modalmask" id="myModalReport" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modalbox rotate">
        ...
        <a href="#close" title="Close" class="close">X</a>
        <div class="modal-body">
            <form id="reportForm" class="form-horizontal" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('bodega', 'reportSalidaBodega') ?>">

                <table class="table table-bordered">
                     <tr>
                                      <th> <?php echo i18n::__('fechaInicio') ?>:</th>
                                      <th>     <input name="report[fecha_inicio]" type="datetime-local">
                        </th>
                                  </tr>
                                  <tr>
                        <th>
                          <?php echo i18n::__('fechaFin') ?>:</th>
                        <th>  <input name="report[fecha_fin]" type="datetime-local">
                        </th>
                    </tr>
                    <tr>
                        <th>  <?php echo i18n::__('empleado') ?>:</th>
