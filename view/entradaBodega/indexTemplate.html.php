...
<!--                        <a id="deleteMasa" href="#" data-target="#myModalEliminarMasivo" data-toggle="modal" class="btn btn-default btn-sm fa fa-exchange"></a>
                    ...
                    <a id="report" href="<?php echo routing::getInstance()->getUrlWeb('bodega', 'reportEntradaBodega') ?>" class="btn btn-primary active btn-sm fa fa-download" ></a>
                                ...
                                <form id="detailForm" class="form-horizontal" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('bodega', 'createDetalleEntrada') ?>">
                                    <div class="modal-body">
                                        <div class="table table-responsive">
                                            ...
                                            <select required="" name="<?php echo detalleEntradaBodegaTableClass::getNameField(detalleEntradaBodegaTableClass::TIPO_INSUMO, true) ?>">
                                                <option value="">...</option>
                                            ...
                                            <select required="" name="<?php echo detalleEntradaBodegaTableClass::getNameField(detalleEntradaBodegaTableClass::ID_INSUMO, true) ?>">
                                                <option value="">...</option>
