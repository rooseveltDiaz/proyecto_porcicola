...
$pdf->Cell(5);
$pdf->Cell(38, 10, utf8_decode('Tipo Insumo'), 1, 0 , 'C');
$pdf->Cell(70, 10, utf8_decode('Nombre'), 1, 0 ,'C');
$pdf->Cell(36, 10, utf8_decode('Fecha Fabricación'), 1);
$pdf->Cell(38, 10, utf8_decode('Fecha Vencimiento'), 1);
$pdf->Cell(29, 10, utf8_decode('Valor'), 1, 0, 'C');
...
foreach ($objInsumo as $key) {
    $pdf->Cell(5);
    $pdf->Cell(38, 10, utf8_decode($key->$tipo), 1);
    $pdf->Cell(70, 10, utf8_decode($key->$nombre), 1);
    $pdf->Cell(36, 10, utf8_decode($key->$fabricacion), 1);
    $pdf->Cell(38, 10, utf8_decode($key->$vencimiento), 1);
    $pdf->Cell(29, 10, utf8_decode($key->$valor), 1);
