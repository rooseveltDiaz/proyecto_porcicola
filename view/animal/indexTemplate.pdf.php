...
$pdf->Cell(5);
$pdf->Cell(35, 10, utf8_decode('N. Identificación'), 1);
...
$pdf->Cell(35, 10, utf8_decode('Lote'), 1);
$pdf->Cell(35, 10, utf8_decode('Raza'), 1);
//$pdf->Cell(30, 10, utf8_decode('Precio'), 1);
$pdf->Ln();
foreach ($objAnimal as $key) {
  $pdf->Cell(5);
    $pdf->Cell(35, 10, utf8_decode($key->numero_identificacion), 1);
    $pdf->Cell(42, 10, utf8_decode($key->fecha_nacimiento), 1);
    $pdf->Cell(20, 10, utf8_decode($key->peso_animal), 1);
    $pdf->Cell(25, 10, utf8_decode($key->nombre_genero), 1);
//    $pdf->Cell(30, 10, utf8_decode($key->numero_parto), 1);
    $pdf->Cell(35, 10, utf8_decode($key->nombre_lote), 1);
    $pdf->Cell(35, 10, utf8_decode($key->nombre_raza), 1);
