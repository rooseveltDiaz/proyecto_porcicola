            ...
            <div class="col-xs-6-offset-3">
                ...
                <table class="table table-bordered ">    
                    ...
                    <tr>
                        ...
                        <th> 
                            <input  min="0" max="20"   placeholder="<?php echo ((isset($objParto) == FALSE) ? i18n::__('machos', NULL, 'parto') : $objParto[0]->$hembras= ucwords($objParto[0]->$hembras)) ?>" type="number" min="0"  name="<?php echo registroPartoTableClass::getNameField(registroPartoTableClass::MACHOS_NACIDOS_VIVOS, true) ?>" >
                        </th>   
                    </tr>
                     <tr>
                        <th>  <?php echo i18n::__('hembras', NULL, 'parto') ?>:</th>
                        <th> 
                            <input min="0" max="20"   placeholder="<?php echo ((isset($objParto) == FALSE) ? i18n::__('hembras', NULL, 'parto') : $objParto[0]->$machos= ucwords($objParto[0]->$machos)) ?>" type="number" min="0"  name="<?php echo registroPartoTableClass::getNameField(registroPartoTableClass::HEMBRAS_NACIDAS_VIVAS, true) ?>" >
                        </th>   
                    </tr>
                  <tr>
                        <th>  <?php echo i18n::__('muertos', NULL, 'parto') ?>:</th>
                        <th> 
                            <input  min="0" max="20" placeholder="<?php echo ((isset($objParto) == FALSE) ? i18n::__('muertos', NULL, 'parto') : $objParto[0]->$muertos= ucwords($objParto[0]->$muertos)) ?>" type="number" min="0"  name="<?php echo registroPartoTableClass::getNameField(registroPartoTableClass::NACIDOS_MUERTOS, true) ?>" >
                        </th>   
                    </tr>
<!--                   <tr>
                        <th>
...
<!--                     <tr>
                        <th>  <?php echo i18n::__('animal', NULL, 'animal') ?>:</th>
                          <th>
                              <select required="" name="<?php echo registroPartoTableClass::getNameField(registroPartoTableClass::ANIMAL_ID, true) ?>">
                                <option>...</option>                              
            ...
            <a id="deleteFilter" class="btn btn-sm btn-default  fa fa-arrow-left" href="<?php echo routing::getInstance()->getUrlWeb('animal', 'indexRegistroParto') ?>"></a>
