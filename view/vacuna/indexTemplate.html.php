                        ...
                        <tbody>
                            <?php foreach ($objVacuna as $key): ?>
                                    ...
                                    <?php if (session::getInstance()->hasCredential('admin') == 1): ?>
                                        <td>
                                           ...
                                           <div class="mdl-tooltip mdl-tooltip--large" for="mas<?php echo $countDetale ?>">
                                                <?php echo i18n::__('compra', null, 'ayuda') ?>
                                            </div>  
                                ...
                                <tr>
                                    <th>
                                        ...
                                        <!-- WINDOWS MODAL INSERTAR MAS VACUNAS -->
                            <div class="modalmask" id="modalInsert<?php echo $key->id ?>">
                                <div class="modalbox rotate">
                                    ...
                                    <form id="detailForm" name="detailForm" class="form-horizontal" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('vacunacion', 'updateInsertVacuna') ?>">
                                        <a href="#close" title="Close" class="close">X</a>

                                        <div class="modal-body">
                                            <input type="hidden" name="<?php echo vacunaTableClass::getNameField(vacunaTableClass::ID, true) ?>" value="<?php echo $key->id ?>">
                                            <?php echo i18n::__('cantidad') ?>
                                            <input type="number" name="<?php echo vacunaTableClass::getNameField(vacunaTableClass::CANTIDAD, true) ?>">    
                                        </div>
