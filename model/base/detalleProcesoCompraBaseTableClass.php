...
/**
 * Description of detalleProcesoCompraBaseTableClass
 *
 * @author Julian Lasso <ingeniero.julianlasso@gmail.com>
 */
class detalleProcesoCompraBaseTableClass extends tableBaseClass {
    ...
    const PROCESO_COMPRA_ID = 'proceso_compra_id';
    const TOTAL = 'total';
    ...
    function setProceso_compra_id($proceso_compra_id) {
        $this->proceso_compra_id = $proceso_compra_id;
    }
