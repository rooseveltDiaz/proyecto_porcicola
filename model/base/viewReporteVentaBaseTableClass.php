...
/**
 * Description of viewReporteVentaBaseTableClass
 *
 * @author Julian Lasso <ingeniero.julianlasso@gmail.com>
 */
class viewReporteVentaBaseTableClass extends tableBaseClass {

    private $factura_venta,
            $fecha,
            $detalle_venta,
            $animal,
    ...
    const FACTURA_VENTA = 'factura_venta';
    const FECHA = 'fecha';
    const DETALLE_VENTA = 'detalle_venta';
    const ANIMAL = 'animal';
    const IDENTIFICACION = 'numero_identificacion';
    const GENERO = 'genero';
    const VALOR = 'valor';
