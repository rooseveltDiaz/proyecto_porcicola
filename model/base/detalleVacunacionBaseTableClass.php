...
class detalleVacunacionBaseTableClass extends tableBaseClass {
    ...
    const VACUNA = 'id_vacuna';
    const FECHA = 'fecha_vacunacion';
    ...
    public static function getNameTable() {
        return 'detalle_registro_vacunas';
    }
    ...
    public static function getAllCount($fields, $deletedLogical = true, $lines = null, $where = null, $table = null) {
        return parent::getAllCount(self::getNameTable(), $fields, $deletedLogical, $lines, $where = null);
    }
