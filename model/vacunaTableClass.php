...
class vacunaTableClass extends vacunaBaseTableClass {
    ...
    public static function validateCreate($nombre, $lote, $fecha_fabricacion, $fecha_vencimiento, $valor, $cantidad, $stock) {
        $flag = false;
        ...
        if ($lote < 0) {
            session::getInstance()->setError(i18n::__(10091, null, 'errors', array('%campo%' => $lote)));
            $flag = true;
            session::getInstance()->setFlash(vacunaTableClass::getNameField(vacunaTableClass::LOTE_VACUNA, true), true);
        }
...
//        }
        ...
        if ($valor < 0) {
            session::getInstance()->setError(i18n::__(10091, null, 'errors', array('%campo%' => $valor)));
            $flag = true;
            session::getInstance()->setFlash(vacunaTableClass::getNameField(vacunaTableClass::VALOR, true), true);
        }
        ...
        if ($cantidad < 0) {
            session::getInstance()->setError(i18n::__(10091, null, 'errors', array('%campo%' => $cantidad)));
            $flag = true;
            session::getInstance()->setFlash(vacunaTableClass::getNameField(vacunaTableClass::CANTIDAD, true), true);
        }
...
//        }
        ...
        if ($stock < 0) {
            session::getInstance()->setError(i18n::__(10091, null, 'errors', array('%campo%' => $stock)));
            $flag = true;
            session::getInstance()->setFlash(vacunaTableClass::getNameField(vacunaTableClass::STOCK_MINIMO, true), true);
        }
...
//        }
    ...
    public static function validateEdit($nombre, $lote, $fecha_fabricacion, $fecha_vencimiento, $valor) {
        $flag = false;
